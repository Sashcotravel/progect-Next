export const Users = [
    ...
    },
    {
        ...
        'nameImg': '30',
        'nameWebp': 'fourCowCinkTwoPost.jpg',
        'prise': 12000,  // 300
        'size': 0,
        'discount': '',
        'total': 12000
...
export const listWash = [
    {
        ...
        'desc': ['Активна піна', 'Основна мийка гелем', 'Полоскання', 'Віск', 'Осмос',
            'Оплата банківською картою Paypass' , 'Оплата готівкою', 'Оплата монетами номіналом 10 грн або жетонами'],
        'desc3': ['Active foam', 'Basic gel wash', 'Rinse', 'Wax', 'Osmosis', 'Payment by Paypass bank card', 'Payment in cash', 'Payment with UAH 10 coins or tokens'],
        'desc4': ['Активная пена', 'Основная мойка гелем', 'Полоскание', 'Воск', 'Осмос',
            'Оплата банковской картой Paypass' , 'Оплата наличными', 'Оплата монетами номиналом 10 грн или жетонами'],
        ...
        'titleH1': ' на Трускавецькй 71, Дрогобич',
        'titleH1EN': ' at Truskavetska 71, Drohobych',
        'titleH1RU': ' на Трускавецкой 71, Дрогобыч',
        "descTitle": "Автомийка самообслуговування на 2 поста для великогабаритного транспорту до 10 тонн. А один " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
          "пом'якшеним водою, змиваємо та наносимо нано віск для захисту вашого лакофарбового покриття. Фінально вибираємо " +
          "програму ополіскування осмотичною водою та надаємо блиск автомобілю.",
        'descTitleEN': "Self-service car wash for 2 stations for large vehicles up to 10 tons. And one duster with tire" +
          " / plastic blackening and air blowing will provide comfort to the car interior. For the best wash, we recommend" +
          " applying active foam to the vehicle. After that, pick up another gun and use the basic washing program with an " +
          "active gel. After finishing the main wash, select the rinse program with softened water, rinse and apply nano" +
          " wax to protect your paintwork. Finally, we select the rinse program with osmotic water and give the car a shine.",
        'descTitleRU': "Автомойка самообслуживания на 2 поста для крупногабаритного транспорта до 10 тонн. А один порохотяга" +
          " с чернением шин/пластика и обдувом воздухом придадут комфорту интерьеру автомобиля. Для лучшего мытья " +
          "рекомендуем нанести активную пену на транспортное средство. После этого взять в руки другой пистолет и использовать" +
          " программу основную мойку активным гелем. Закончив основную мойку выбираем программу пополковки смягченной водой, " +
    ...
    },
    {
        ...
        'desc4': ['Активная пена', 'Основная мойка гелем', 'Полоскание', 'Воск', 'Осмос',
            'Оплата банковской картой Paypass' , 'Оплата наличными', 'Оплата монетами номиналом 10 грн или жетонами'],
        'titleH1': ' на Городецького 27 б, Рогатин',
        'titleH1EN': ' at Horodetskoho 27 b, Rohatyn',
        'titleH1RU': ' на Городецкого 27 б, Рогатин',
        "descTitle": "Автомийка самообслуговування на 3 поста для великогабаритного транспорту до 10 тонн. А один " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
          "пом'якшеним водою, змиваємо та наносимо нано віск для захисту вашого лакофарбового покриття. Фінально вибираємо " +
          "програму ополіскування осмотичною водою та надаємо блиск автомобілю.",
        'descTitleEN': "Self-service car wash for 3 stations for large vehicles up to 10 tons. And one duster with tire" +
          " / plastic blackening and air blowing will provide comfort to the car interior. For the best wash, we recommend" +
          " applying active foam to the vehicle. After that, pick up another gun and use the basic washing program with an " +
          "active gel. After finishing the main wash, select the rinse program with softened water, rinse and apply nano" +
          " wax to protect your paintwork. Finally, we select the rinse program with osmotic water and give the car a shine.",
        'descTitleRU': "Автомойка самообслуживания на 3 поста для крупногабаритного транспорта до 10 тонн. А один порохотяга" +
          " с чернением шин/пластика и обдувом воздухом придадут комфорту интерьеру автомобиля. Для лучшего мытья " +
          "рекомендуем нанести активную пену на транспортное средство. После этого взять в руки другой пистолет и использовать" +
          " программу основную мойку активным гелем. Закончив основную мойку выбираем программу пополковки смягченной водой, " +
          "смываем и наносим нано воск для защиты вашего лакокрасочного покрытия. Финально выбираем программу ополаскивания " +
        ...
        'obl3': 'Франковская область',
        'st': 'Городецького 27 б',
        'st2': 'horodetsky-27',
        'st3': 'Horodetskoho 27 b',
        'st4': 'Городецкого 27 б',
    ...
    },
    {
        ...
        'st3': '',
        'st4': '',
        'map': 'https://www.google.com/maps/place/%D0%A0%D0%BE%D0%B6%D0%BD%D1%96%D0%B2,+%D0%86%D0%B2%D0%B0%D0%BD%D0%BE-%D0' +
          '%A4%D1%80%D0%B0%D0%BD%D0%BA%D1%96%D0%B2%D1%81%D1%8C%D0%BA%D0%B0+%D0%BE%D0%B1%D0%BB%D0%B0%D1%81%D1%82%D1%8C,+7863' +
          '5/@48.3668107,25.2054759,14z/data=!3m1!4b1!4m6!3m5!1s0x4736b799d973a375:0xa836bf6262fe50c4!8m2!3d48.3667546!4d' +
          '25.2298685!16s%2Fg%2F121pw9cq?entry=ttu'
    },
    {
        'name': 'Мийка самообслуговування 3 поста',
        'desc': ['Активна піна', 'Основна мийка гелем', 'Полоскання', 'Віск', 'Осмос',
        ...
        'desc4': ['Активная пена', 'Основная мойка гелем', 'Полоскание', 'Воск', 'Осмос',
            'Оплата банковской картой Paypass' , 'Оплата наличными', 'Оплата монетами номиналом 10 грн или жетонами'],
        'desc2': 'Для обслуговування великогабаритних автомобілів (до 10 тонн) передбачено 1 пост. Для зручності відвідувачів передбачено 1 пилосос потужністю 3 кВт.',
        'titleH1': ' на Михайла Грушевського 1, Монастирське',
        'titleH1EN': ' at Mykhailo Hrushevskyi 1, Monastyrske',
        'titleH1RU': ' на Михаила Грушевского 1, Монастырское',
        "descTitle": "Автомийка самообслуговування на 3 поста для великогабаритного транспорту до 10 тонн. А один " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
        ...
        'obl3': 'Тернопольская область',
        'st': 'Михайла Грушевського 1',
        'st2': 'mykhailo-hrushevskyi-1',
        'st3': 'Mykhailo Hrushevskyi 1',
        'st4': 'Михаила Грушевского 1',
    ...
    },
    {
        ...
        'desc4': ['Активная пена', 'Основная мойка гелем', 'Полоскание', 'Воск', 'Осмос',
            'Оплата банковской картой Paypass' , 'Оплата наличными', 'Оплата монетами номиналом 10 грн или жетонами'],
        'desc2': 'Для обслуговування великогабаритних автомобілів (до 10 тонн) передбачено 1 пост. Для зручності відвідувачів передбачено 1 пилосос потужністю 3 кВт.',
        'titleH1': ' на Миру, Рахів',
        'titleH1EN': ' at Myru, Rakhiv',
        'titleH1RU': ' на Мира, Рахов',
        "descTitle": "Автомийка самообслуговування на 3 поста для великогабаритного транспорту до 10 тонн. А один " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
    ...
    },
    {
        ...
        'desc': ['Попередня мийка піною', 'Основна мийка гелем', 'Полоскання', 'Віск', 'Осмос',
            'Оплата банківською картою Paypass' , 'Оплата готівкою', 'Оплата монетами номіналом 10 грн або жетонами'],
        'desc3': ['Pre-wash with foam', 'Basic gel wash', 'Rinse', 'Wax', 'Osmosis', 'Payment by Paypass bank card', 'Payment in cash', 'Payment with UAH 10 coins or tokens'],
        'desc4': ['Предварительная мойка пеной', 'Основная мойка гелем', 'Полоскание', 'Воск', 'Осмос',
            'Оплата банковской картой Paypass' , 'Оплата наличными', 'Оплата монетами номиналом 10 грн или жетонами'],
        ...
        'titleH1': ' на T0606, Ильниці',
        'titleH1EN': ' at T0606, Ilnytsia',
        'titleH1RU': ' на T0606, Ильницы',
        "descTitle": "Автомийка самообслуговування на 3 поста для великогабаритного транспорту до 10 тонн. А один " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
        ...
        'descTitleRU': "Автомойка самообслуживания на 3 поста для крупногабаритного транспорта до 10 тонн. А один порохотяга" +
          ...
          "осмотической водой и придаем блеск автомобилю.",
        'colPost': 3,
        // 'src': [require('./image/Location/Ilnitsi/1-compressed.jpg'), require('./image/Location/Ilnitsi/2.jpeg'), require('./image/Location/Ilnitsi/3.jpeg'), require('./image/Location/Ilnitsi/4-compressed.jpg'), require('./image/Location/Ilnitsi/5.jpeg'), require('./image/Location/Ilnitsi/6-compressed.jpg'), require('./image/Location/Ilnitsi/7-compressed.jpg'), require('./image/Location/Ilnitsi/8-compressed.jpg'), require('./image/Location/Ilnitsi/10-compressed.jpg'), require('./image/Location/Ilnitsi/11.jpeg'),],
        // 'src2': [require('./image/Location/IlnitsiWebp/1.webp'), require('./image/Location/IlnitsiWebp/2.webp'), require('./image/Location/IlnitsiWebp/3.webp'), require('./image/Location/IlnitsiWebp/4.webp'), require('./image/Location/IlnitsiWebp/5.webp'), require('./image/Location/IlnitsiWebp/6.webp'), require('./image/Location/IlnitsiWebp/7.webp'), require('./image/Location/IlnitsiWebp/8.webp'), require('./image/Location/IlnitsiWebp/9.webp'), require('./image/Location/IlnitsiWebp/10.webp'), require('./image/Location/IlnitsiWebp/11.webp'),],
        'imgNum': 6,
        'city': 'Ильниці',
        'city2': 'Ilnytsia',
        'city3': 'Ilnytsia',
    ...
    },
    {
        ...
        'desc2': 'Перша мийка самообслуговувания для миття ФУР 20+ метрів в Україні. Унікальна розрабка консолі і обладняння дозволяє отримати чистий автомобіль, ' +
          'навіть Фуру. Комбінація обляднання і миючих засобів.',
        'titleH1': ' на Патона 4, Львів',
        'titleH1EN': ' at Paton 4, Lviv',
        'titleH1RU': ' на Патона 4, Львов',
        "descTitle": "Автомийка самообслуговування на 3 поста для великогабаритного транспорту до 10 тонн. А один " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
        ...
        'descTitleRU': "Автомойка самообслуживания на 3 поста для крупногабаритного транспорта до 10 тонн. А один порохотяга" +
          ...
          "осмотической водой и придаем блеск автомобилю.",
        'colPost': 3,
        // 'src': [require('./image/Location/patonaLviv/1.jpg'), require('./image/Location/patonaLviv/2.jpg'), require('./image/Location/patonaLviv/3.jpg'), require('./image/Location/patonaLviv/4.jpg'), require('./image/Location/patonaLviv/5.jpg'), require('./image/Location/patonaLviv/6.jpg'), require('./image/Location/patonaLviv/7.jpg'), require('./image/Location/patonaLviv/8.jpg'),],
        // 'src2': [require('./image/Location/patonaLvivWebp/1.webp'), require('./image/Location/patonaLvivWebp/2.webp'), require('./image/Location/patonaLvivWebp/3.webp'), require('./image/Location/patonaLvivWebp/4.webp'), require('./image/Location/patonaLvivWebp/5.webp'), require('./image/Location/patonaLvivWebp/6.webp'), require('./image/Location/patonaLvivWebp/7.webp'), require('./image/Location/patonaLvivWebp/8.webp'),],
        'imgNum': 28,
        'city': 'Львів',
        'city2': 'Lviv6',
        'city3': 'Lviv',
    ...
    },
    {
        ...
        'desc': ['Попередня мийка піною', 'Основна мийка гелем', 'Полоскання', 'Віск', 'Осмос',
            'Оплата банківською картою Paypass' , 'Оплата готівкою', 'Оплата монетами номіналом 10 грн або жетонами'],
        'desc3': ['Pre-wash with foam', 'Main wash with gel', 'Rinse', 'Wax', 'Osmosis', 'Payment by Paypass bank card', 'Payment in cash', 'Payment with UAH 10 coins or tokens'],
        'desc4': ['Предварительная мойка пеной', 'Основная мойка гелем', 'Полоскание', 'Воск', 'Осмос',
            'Оплата банковской картой Paypass' , 'Оплата наличными', 'Оплата монетами номиналом 10 грн или жетонами'],
        'desc2': '',
        'titleH1': ' в Пустомити',
        'titleH1EN': ' at Pustomyty',
        'titleH1RU': ' в Пустомыты',
        "descTitle": "Автомийка самообслуговування на 3 поста для великогабаритного транспорту до 10 тонн. А один " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
        ...
        'st3': '',
        'st4': '',
        'map': 'https://www.google.com/maps/place/%D0%9F%D1%83%D1%81%D1%82%D0%BE%D0%BC%D0%B8%D1%82%D0%B8,+%D0%9B%D1%8' +
          'C%D0%B2%D1%96%D0%B2%D1%81%D1%8C%D0%BA%D0%B0+%D0%BE%D0%B1%D0%BB%D0%B0%D1%81%D1%82%D1%8C,+81100/@49.7204839,23' +
          '.8849206,14z/data=!3m1!4b1!4m6!3m5!1s0x473ae50fda23b1bb:0x8ca50482b33351d5!8m2!3d49.7154835!4d23.9055618!' +
          '16zL20vMGd0NWg4?entry=ttu'
    },
    {
        'name': 'Мийка самообслуговування 3 постів',
        'desc': ['Попередня мийка піною', 'Основна мийка гелем', 'Полоскання', 'Віск', 'Осмос',
            'Оплата банківською картою Paypass' , 'Оплата готівкою', 'Оплата монетами номіналом 10 грн або жетонами'],
        'desc3': ['Pre-wash with foam', 'Main wash with gel', 'Rinse', 'Wax', 'Osmosis', 'Payment by Paypass bank card', 'Payment in cash', 'Payment with UAH 10 coins or tokens'],
        'desc4': ['Предварительная мойка пеной', 'Основная мойка гелем', 'Полоскание', 'Воск', 'Осмос',
        ...
        'st3': '',
        'st4': '',
        'map': 'https://www.google.com/maps/place/%D0%A8%D0%B0%D1%86%D1%8C%D0%BA,+%D0%92%D0%BE%D0%BB%D0%B8%D0%BD%D1%81%D' +
          '1%8C%D0%BA%D0%B0+%D0%BE%D0%B1%D0%BB%D0%B0%D1%81%D1%82%D1%8C/@51.4879123,23.8882765,13z/data=!3m1!4b1!4m6!3m5' +
          '!1s0x4723fb7039d667e7:0xf493e7dd0c82fddd!8m2!3d51.4975426!4d23.9323386!16zL20vMDRsZHp6?entry=ttu'
    },
    {
        ...
        'desc2': 'Для обслуговування великогабаритних автомобілів (до 10 тонн) передбачено 1 пост. Для зручності відвідувачів передбачено 1 пилосос потужністю 3 кВт.',
        'titleH1': ' в Коломия',
        'titleH1EN': ' at Kolomyia',
        'titleH1RU': ' в Коломыя',
        "descTitle": "Автомийка самообслуговування на 4 поста для великогабаритного транспорту до 10 тонн. А один " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
          "пом'якшеним водою, змиваємо та наносимо нано віск для захисту вашого лакофарбового покриття. Фінально вибираємо " +
          "програму ополіскування осмотичною водою та надаємо блиск автомобілю.",
        'descTitleEN': "Self-service car wash for 4 stations for large vehicles up to 10 tons. And one duster with tire" +
          " / plastic blackening and air blowing will provide comfort to the car interior. For the best wash, we recommend" +
          " applying active foam to the vehicle. After that, pick up another gun and use the basic washing program with an " +
          "active gel. After finishing the main wash, select the rinse program with softened water, rinse and apply nano" +
          " wax to protect your paintwork. Finally, we select the rinse program with osmotic water and give the car a shine.",
        'descTitleRU': "Автомойка самообслуживания на 4 поста для крупногабаритного транспорта до 10 тонн. А один порохотяга" +
          " с чернением шин/пластика и обдувом воздухом придадут комфорту интерьеру автомобиля. Для лучшего мытья " +
          "рекомендуем нанести активную пену на транспортное средство. После этого взять в руки другой пистолет и использовать" +
          " программу основную мойку активным гелем. Закончив основную мойку выбираем программу пополковки смягченной водой, " +
          "смываем и наносим нано воск для защиты вашего лакокрасочного покрытия. Финально выбираем программу ополаскивания " +
        ...
        'st3': '',
        'st4': '',
        'map': 'https://www.google.com/maps/place/%D0%9A%D0%BE%D0%BB%D0%BE%D0%BC%D0%B8%D1%8F,+%D0%86%D0%B2%D0%B0%D0%BD%' +
          'D0%BE-%D0%A4%D1%80%D0%B0%D0%BD%D0%BA%D1%96%D0%B2%D1%81%D1%8C%D0%BA%D0%B0+%D0%BE%D0%B1%D0%BB%D0%B0%D1%81%D1%8' +
          '2%D1%8C,+78200/@48.540637,24.9927451,13z/data=!3m1!4b1!4m6!3m5!1s0x4736d2957ef4cbdf:0xc1e2a9b84387bf00!8m2!3' +
          'd48.5304917!4d25.0412055!16zL20vMDZnbDZw?entry=ttu'
    },
    {
        'name': 'Мийка самообслуговування 4 поста',
        'desc': ['Активна піна', 'Основна мийка гелем', 'Полоскання', 'Віск', 'Осмос',
        ...
        'desc2': 'Для обслуговування великогабаритних автомобілів (до 10 тонн) передбачено 1 пост. Для зручності відвідувачів передбачено 1 пилосос потужністю 3 кВт.',
        'titleH1': ' в Букачівці',
        'titleH1EN': ' at Bukachevtsi',
        'titleH1RU': ' в Букачевцы',
        "descTitle": "Автомийка самообслуговування на 4 поста для великогабаритного транспорту до 10 тонн. А один " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
        ...
        'st3': '',
        'st4': '',
        'map': 'https://www.google.com/maps/place/%D0%91%D1%83%D0%BA%D0%B0%D1%87%D1%96%D0%B2%D1%86%D1%96,+%D0%86%D0%B2%' +
          'D0%B0%D0%BD%D0%BE-%D0%A4%D1%80%D0%B0%D0%BD%D0%BA%D1%96%D0%B2%D1%81%D1%8C%D0%BA%D0%B0+%D0%BE%D0%B1%D0%BB%D0%B' +
          '0%D1%81%D1%82%D1%8C,+77066/@49.2582802,24.4852569,14z/data=!3m1!4b1!4m6!3m5!1s0x4730838743ae02f9:0x1da11cacf' +
          '63c3a3d!8m2!3d49.2518098!4d24.4987913!16s%2Fm%2F04yg7b2?entry=ttu'
    },
    {
        'name': 'Мийка самообслуговування 4 поста',
        'desc': ['Активна піна', 'Основна мийка гелем', 'Полоскання', 'Віск', 'Осмос',
        ...
        'desc4': ['Активная пена', 'Основная мойка гелем', 'Полоскание', 'Воск', 'Осмос',
            'Оплата банковской картой Paypass' , 'Оплата наличными', 'Оплата монетами номиналом 10 грн или жетонами'],
        'desc2': 'Для обслуговування великогабаритних автомобілів (до 10 тонн) передбачено 1 пост. Для зручності відвідувачів передбачено 1 пилосос потужністю 3 кВт.',
        'titleH1': ' на Человська, Коростень',
        'titleH1EN': ' at Chelovska, Korosten',
        'titleH1RU': ' на Человецкая, Коростень',
        "descTitle": "Автомийка самообслуговування на 4 поста для великогабаритного транспорту до 10 тонн. А один " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
        ...
        'descTitleRU': "Автомойка самообслуживания на 4 поста для крупногабаритного транспорта до 10 тонн. А один порохотяга" +
          ...
          "осмотической водой и придаем блеск автомобилю.",
        'colPost': 4,
        // 'src': [require('./image/Location/Corosten/2.jpg'), require('./image/Location/Corosten/3.jpg'),],
        // 'src2': [require('./image/Location/CorostenWebp/2.webp'), require('./image/Location/CorostenWebp/3.webp')],
        'imgNum': 7,
        'city': 'Коростень',
        'city2': 'Korosten',
        'city3': 'Korosten',
    ...
    },
    {
        ...
        'desc2': 'Для обслуговування великогабаритних автомобілів (до 10 тонн) передбачено 1 пост. Для зручності відвідувачів передбачено 1 пилосос потужністю 3 кВт.',
        'titleH1': ' в Терновиця',
        'titleH1EN': ' at Ternovitsa',
        'titleH1RU': ' в Терновница',
        "descTitle": "Автомийка самообслуговування на 4 поста для великогабаритного транспорту до 10 тонн. А один " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
        ...
        'st3': '',
        'st4': '',
        'map': 'https://www.google.com/maps/dir/%D0%A2%D0%B5%D1%80%D0%BD%D0%BE%D0%B2%D0%B8%D1%86%D1%8F,+%D0%9B%D1%8C%D' +
          '0%B2%D1%96%D0%B2%D1%81%D1%8C%D0%BA%D0%B0+%D0%BE%D0%B1%D0%BB%D0%B0%D1%81%D1%82%D1%8C/%D0%A2%D0%B5%D1%80%D0%BD%' +
          'D0%BE%D0%B2%D0%B8%D1%86%D1%8F,+%D0%9B%D1%8C%D0%B2%D1%96%D0%B2%D1%81%D1%8C%D0%BA%D0%B0+%D0%BE%D0%B1%D0%BB%D0%B' +
          '0%D1%81%D1%82%D1%8C/@49.9081361,23.4814828,14.25z/data=!4m14!4m13!1m5!1m1!1s0x473b1667b6b41e95:0x202842bc1226' +
          'd8ca!2m2!1d23.4818694!2d49.9093501!1m5!1m1!1s0x473b1667b6b41e95:0x202842bc1226d8ca!2m2!1d23.4818694!2d49.9093' +
          '501!3e0?entry=ttu',
    },
    {
        'name': 'Мийка самообслуговування 4 поста',
        ...
        'desc4': ['Активная пена', 'Основная мойка гелем', 'Полоскание', 'Воск', 'Осмос',
            'Оплата банковской картой Paypass' , 'Оплата наличными', 'Оплата монетами номиналом 10 грн или жетонами'],
        'desc2': 'Для обслуговування великогабаритних автомобілів (до 10 тонн) передбачено 1 пост. Для зручності відвідувачів передбачено 1 пилосос ' +
          'потужністю 3 кВт. Оплата купюрами на постах',
        'titleH1': ' на Хирівська 24, Добромиль',
        'titleH1EN': ' at Khirivska 24, Dobromil',
        'titleH1RU': ' на Хыровская 24, Добромиль',
        "descTitle": "Автомийка самообслуговування на 4 поста для великогабаритного транспорту до 10 тонн. А один " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
    ...
    },
    {
        ...
        'desc4': ['Активная пена', 'Основная мойка гелем', 'Полоскание', 'Воск', 'Осмос',
            'Оплата банковской картой Paypass' , 'Оплата наличными', 'Оплата монетами номиналом 10 грн или жетонами'],
        'desc2': 'Для обслуговування великогабаритних автомобілів (до 10 тонн) передбачено 1 пост. Для зручності відвідувачів передбачено 1 пилосос потужністю 3 кВт.',
        'titleH1': ' в Новий Розділ',
        'titleH1EN': ' at Noviy Rozdil',
        'titleH1RU': ' в Новый Раздел',
        "descTitle": "Автомийка самообслуговування на 4 поста для великогабаритного транспорту до 10 тонн. А один " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
        ...
        'st3': '',
        'st4': '',
        'map': 'https://www.google.com/maps/dir//%D0%9D%D0%BE%D0%B2%D0%B8%D0%B9+%D0%A0%D0%BE%D0%B7%D0%B4%D1%96%D0%BB,+%D' +
          '0%9B%D1%8C%D0%B2%D1%96%D0%B2%D1%81%D1%8C%D0%BA%D0%B0+%D0%BE%D0%B1%D0%BB%D0%B0%D1%81%D1%82%D1%8C/@49.4744825' +
          ',24.0590188,12z/data=!4m8!4m7!1m0!1m5!1m1!1s0x473a8a13cbe5f5cf:0xaf8a40ec432b61ea!2m2!1d24.1290584!2d49.4745036?entry=ttu',
    },
    {
        'name': 'Мийка самообслуговування 4 поста',
        'desc': ['Активна піна', 'Основна мийка гелем', 'Полоскання', 'Віск', 'Осмос',
        ...
        'desc4': ['Активная пена', 'Основная мойка гелем', 'Полоскание', 'Воск', 'Осмос',
            'Оплата банковской картой Paypass' , 'Оплата наличными', 'Оплата монетами номиналом 10 грн или жетонами'],
        'desc2': 'Для обслуговування великогабаритних автомобілів (до 10 тонн) передбачено 1 пост. Для зручності відвідувачів передбачено 1 пилосос потужністю 3 кВт.',
        'titleH1': ' на Львівській, Давидів',
        'titleH1EN': ' at Lvivska, Davidov',
        'titleH1RU': ' на Львовской, Давыдов',
        "descTitle": "Автомийка самообслуговування на 4 поста для великогабаритного транспорту до 10 тонн. А один " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
    ...
    {
        'name': 'Мийка самообслуговування 4 поста',
        'desc': ['Активна піна', 'Основна мийка гелем', 'Полоскання', 'Віск', 'Осмос', 'Щітка',
            'Оплата банківською картою Paypass' , 'Оплата готівкою', 'Оплата монетами номіналом 10 грн або жетонами'],
        'desc3': ['Active foam', 'Basic gel wash', 'Rinse', 'Wax', 'Osmosis', 'Brush', 'Payment by Paypass bank card', 'Payment in cash', 'Payment with UAH 10 coins or tokens'],
        'desc4': ['Активная пена', 'Основная мойка гелем', 'Полоскание', 'Воск', 'Осмос', 'Щетка',
            'Оплата банковской картой Paypass' , 'Оплата наличными', 'Оплата монетами номиналом 10 грн или жетонами'],
        ...
        'titleH1': ' на Брестська 4, Любомль',
        'titleH1EN': ' at Brestska 4, Luboml',
        'titleH1RU': ' на Брестская 4, Любомль',
        "descTitle": "Автомийка самообслуговування на 4 поста для великогабаритного транспорту до 10 тонн. А один " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
    ...
    },
    {
        ...
        'desc': ['Гель', 'Основна мийка гелем', 'Полоскання', 'Віск', 'Осмос',
            'Оплата банківською картою Paypass' , 'Оплата готівкою', 'Оплата монетами номіналом 10 грн або жетонами'],
        'desc3': ['Gel', 'Basic gel wash', 'Rinse', 'Wax', 'Osmosis', 'Payment by Paypass bank card', 'Payment in cash', 'Payment with UAH 10 coins or tokens'],
        'desc4': ['Гель', 'Основная мойка гелем', 'Полоскание', 'Воск', 'Осмос',
            'Оплата банковской картой Paypass' , 'Оплата наличными', 'Оплата монетами номиналом 10 грн или жетонами'],
        'desc2': '',
        'titleH1': ' Попасне',
        'titleH1EN': ' at Popasne',
        'titleH1RU': ' Попасное',
        "descTitle": "Автомийка самообслуговування на 5 поста для великогабаритного транспорту до 10 тонн. А один " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
          "пом'якшеним водою, змиваємо та наносимо нано віск для захисту вашого лакофарбового покриття. Фінально вибираємо " +
          "програму ополіскування осмотичною водою та надаємо блиск автомобілю.",
        'descTitleEN': "Self-service car wash for 5 stations for large vehicles up to 10 tons. And one duster with tire" +
          " / plastic blackening and air blowing will provide comfort to the car interior. For the best wash, we recommend" +
          " applying active foam to the vehicle. After that, pick up another gun and use the basic washing program with an " +
          "active gel. After finishing the main wash, select the rinse program with softened water, rinse and apply nano" +
          " wax to protect your paintwork. Finally, we select the rinse program with osmotic water and give the car a shine.",
        'descTitleRU': "Автомойка самообслуживания на 5 поста для крупногабаритного транспорта до 10 тонн. А один порохотяга" +
          " с чернением шин/пластика и обдувом воздухом придадут комфорту интерьеру автомобиля. Для лучшего мытья " +
          "рекомендуем нанести активную пену на транспортное средство. После этого взять в руки другой пистолет и использовать" +
          " программу основную мойку активным гелем. Закончив основную мойку выбираем программу пополковки смягченной водой, " +
          "смываем и наносим нано воск для защиты вашего лакокрасочного покрытия. Финально выбираем программу ополаскивания " +
    ...
    },
    {
        ...
        'desc4': ['Гель', 'Основная мойка гелем', 'Полоскание', 'Воск', 'Осмос',
            'Оплата банковской картой Paypass' , 'Оплата наличными', 'Оплата монетами номиналом 10 грн или жетонами'],
        'desc2': 'Мийка самообслуговування на 5 постів - 4 для легкових и 1 для грузових авто. Дизайн накриття - Marco. Перегородки - скло.',
        'titleH1': ' на T0212, Лука Мелешковская',
        'titleH1EN': ' at T0212, Luka Meleshkivska',
        'titleH1RU': ' на T0212, Лука Мелешковская',
        "descTitle": "Автомийка самообслуговування на 5 поста для великогабаритного транспорту до 10 тонн. А один " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
        ...
        'city3': 'Luka Meleshkivska',
        'city4': 'Лука Мелешковская',
        'obl': 'Вінницька область',
        'obl2': 'Vinnytska Oblast',
        'obl3': 'Винницкая область',
        'st': 'T0212',
    ...
    },
    {
        ...
        'titleH1': ' на Пирогова 135, Вінниця',
        'titleH1EN': ' at Pirogov 135, Vinnitsa',
        'titleH1RU': ' на Пирогова 135, Винница',
        "descTitle": "Автомийка самообслуговування на 5 поста для великогабаритного транспорту до 10 тонн. А один " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
    ...
    },
    {
        ...
        'titleH1': ' на Львівська 38, Городок',
        'titleH1EN': ' at Lvivska 38, Horodok',
        'titleH1RU': ' на Львовская 38, Городок',
        "descTitle": "Автомийка самообслуговування на 5 поста для великогабаритного транспорту до 10 тонн. А один " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
    ...
    },
    {
        ...
        'desc4': ['Гель', 'Основная мойка гелем', 'Полоскание', 'Воск', 'Осмос',
            'Оплата банковской картой Paypass' , 'Оплата наличными', 'Оплата монетами номиналом 10 грн или жетонами'],
        'desc2': '',
        'titleH1': ' на Текстильна 22, Тернопіль',
        'titleH1EN': ' at Textile 22, Ternopil',
        'titleH1RU': ' на Текстильная 22, Тернополь',
        "descTitle": "Автомийка самообслуговування на 6 поста для великогабаритного транспорту до 10 тонн. А один " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
          "пом'якшеним водою, змиваємо та наносимо нано віск для захисту вашого лакофарбового покриття. Фінально вибираємо " +
          "програму ополіскування осмотичною водою та надаємо блиск автомобілю.",
        'descTitleEN': "Self-service car wash for 6 stations for large vehicles up to 10 tons. And one duster with tire" +
          " / plastic blackening and air blowing will provide comfort to the car interior. For the best wash, we recommend" +
          " applying active foam to the vehicle. After that, pick up another gun and use the basic washing program with an " +
          "active gel. After finishing the main wash, select the rinse program with softened water, rinse and apply nano" +
          " wax to protect your paintwork. Finally, we select the rinse program with osmotic water and give the car a shine.",
        'descTitleRU': "Автомойка самообслуживания на 6 поста для крупногабаритного транспорта до 10 тонн. А один порохотяга" +
          " с чернением шин/пластика и обдувом воздухом придадут комфорту интерьеру автомобиля. Для лучшего мытья " +
          "рекомендуем нанести активную пену на транспортное средство. После этого взять в руки другой пистолет и использовать" +
          " программу основную мойку активным гелем. Закончив основную мойку выбираем программу пополковки смягченной водой, " +
          "смываем и наносим нано воск для защиты вашего лакокрасочного покрытия. Финально выбираем программу ополаскивания " +
    ...
    },
    {
        ...
        'titleH1': ' на Березинська 38, Дніпропетровськ',
        'titleH1EN': ' at Berezynska 38, Dnipropetrovsk',
        'titleH1RU': ' на Березинская 38, Днепропетровск',
        "descTitle": "Автомийка самообслуговування на 6 поста для великогабаритного транспорту до 10 тонн. А два " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
          "пом'якшеним водою, змиваємо та наносимо нано віск для захисту вашого лакофарбового покриття. Фінально вибираємо " +
          "програму ополіскування осмотичною водою та надаємо блиск автомобілю.",
        'descTitleEN': "Self-service car wash for 6 stations for large vehicles up to 10 tons. And two duster with tire" +
          " / plastic blackening and air blowing will provide comfort to the car interior. For the best wash, we recommend" +
          " applying active foam to the vehicle. After that, pick up another gun and use the basic washing program with an " +
          "active gel. After finishing the main wash, select the rinse program with softened water, rinse and apply nano" +
          " wax to protect your paintwork. Finally, we select the rinse program with osmotic water and give the car a shine.",
        'descTitleRU': "Автомойка самообслуживания на 6 поста для крупногабаритного транспорта до 10 тонн. А два порохотяга" +
          " с чернением шин/пластика и обдувом воздухом придадут комфорту интерьеру автомобиля. Для лучшего мытья " +
          "рекомендуем нанести активную пену на транспортное средство. После этого взять в руки другой пистолет и использовать" +
          " программу основную мойку активным гелем. Закончив основную мойку выбираем программу пополковки смягченной водой, " +
          "смываем и наносим нано воск для защиты вашего лакокрасочного покрытия. Финально выбираем программу ополаскивания " +
    ...
    {
        'name': 'Мийка самообслуговування 6 постів',
        'desc': ['Гель', 'Основна мийка гелем', 'Полоскання', 'Віск', 'Осмос', 'Щітка',
            'Оплата банківською картою Paypass' , 'Оплата готівкою', 'Оплата монетами номіналом 10 грн або жетонами'],
        'desc3': ['Gel', 'Basic gel wash', 'Rinse', 'Wax', 'Osmosis', 'Brush', 'Payment by Paypass bank card', 'Payment in cash', 'Payment with UAH 10 coins or tokens'],
        'desc4': ['Гель', 'Основная мойка гелем', 'Полоскание', 'Воск', 'Осмос', 'Щетка',
            'Оплата банковской картой Paypass' , 'Оплата наличными', 'Оплата монетами номиналом 10 грн или жетонами'],
        'desc2': 'Для обслуговування великогабаритних автомобілей (до 10 тонн) передбачено два відкритих пости з ' +
          'додатковою програмою №3 "Миття щіткою". Для зручності відвідувачів передбачено два пилососа потужністю 3 кВт.',
        'titleH1': ' на Коритнянська, Ужгород',
        'titleH1EN': ' at Korytnianska, Uzhhorod',
        'titleH1RU': ' на Корытнянская, Ужгород',
        "descTitle": "Автомийка самообслуговування на 6 поста для великогабаритного транспорту до 10 тонн. А два " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
    ...
    },
    {
        ...
        'desc2': 'Для обслуговування великогабаритних автомобілей (до 10 тонн) передбачено два відкритих пости з ' +
          'додатковою програмою №3 "Миття щіткою". Для зручності відвідувачів передбачено два пилососа потужністю 3 кВт.',
        'titleH1': ' на Лісова, Берегове',
        'titleH1EN': ' at Lisova, Berehove',
        'titleH1RU': ' на Лесная, Берегово',
        "descTitle": "Автомийка самообслуговування на 6 поста для великогабаритного транспорту до 10 тонн. А два " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
    ...
    },
    {
        ...
        'desc': ['Піна', 'Основна мийка гелем', 'Полоскання', 'Віск', 'Осмос', 'Щітка',
            'Оплата банківською картою Paypass' , 'Оплата готівкою', 'Оплата монетами номіналом 10 грн або жетонами'],
        'desc3': ['Foam', 'Basic gel wash', 'Rinse', 'Wax', 'Osmosis', 'Brush', 'Payment by Paypass bank card', 'Payment in cash', 'Payment with UAH 10 coins or tokens'],
        'desc4': ['Пина', 'Основная мойка гелем', 'Полоскание', 'Воск', 'Осмос', 'Щетка',
            'Оплата банковской картой Paypass' , 'Оплата наличными', 'Оплата монетами номиналом 10 грн или жетонами'],
        'desc2': '',
        'titleH1': ' Софіївка',
        'titleH1EN': ' at Sofievka',
        'titleH1RU': ' Софиевка',
        "descTitle": "Автомийка самообслуговування на 6 поста для великогабаритного транспорту до 10 тонн. А два " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
    ...
    },
    {
        ...
        'titleH1': ' на Галицька 2г, Радехів',
        'titleH1EN': ' at Halytska 2h, Radekhov',
        'titleH1RU': ' на Галицкая 2г, Радехов',
        "descTitle": "Автомийка самообслуговування на 6 поста для великогабаритного транспорту до 10 тонн. А два " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
    ...
    },
    {
        ...
        'desc': ['Попередня мийка гелем', 'Основна мийка гелем', 'Полоскання', 'Віск', 'Осмос', 'Щітка',
            'Оплата банківською картою Paypass' , 'Оплата готівкою', 'Оплата монетами номіналом 10 грн або жетонами'],
        'desc3': ['Pre-wash with gel', 'Basic gel wash', 'Rinse', 'Wax', 'Osmosis', 'Brush', 'Payment by Paypass bank' +
        ' card', 'Payment in cash', 'Payment with UAH 10 coins or tokens'],
        'desc4': ['Предварительная мойка гелем', 'Основная мойка гелем', 'Полоскание', 'Воск', 'Осмос', 'Щетка',
            'Оплата банковской картой Paypass' , 'Оплата наличными', 'Оплата монетами номиналом 10 грн или жетонами'],
        'desc2': 'Для обслуговування великогабаритних автомобілей (до 10 тонн) передбачено два відкритих пости з ' +
          'додатковою програмою №3 "Миття щіткою". Для зручності відвідувачів передбачено два пилососа потужністю 3 кВт.',
        'titleH1': ' на Шевченка 360Г, Львів',
        'titleH1EN': ' at Shevchenko 360h, Lviv',
        'titleH1RU': ' на Шевченко 360Г, Львов',
        "descTitle": "Автомийка самообслуговування на 6 поста для великогабаритного транспорту до 10 тонн. А два " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
    ...
    },
    {
        ...
        'titleH1': ' на Промислова 1б, Стрий',
        'titleH1EN': ' at Promyslova 1b, Stryi',
        'titleH1RU': ' на Промышленная 1б, Стрый',
        "descTitle": "Автомийка самообслуговування на 6 поста для великогабаритного транспорту до 10 тонн. А два " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
    ...
    },
    {
        ...
        'titleH1': ' на Рудненській 14, Львів',
        'titleH1EN': ' at Rudnenska 14, Lviv',
        'titleH1RU': ' на Рудненской 14, Львов',
        'descTitle1': 'Вітаємо вас на автомийці самообслуговування, де ви можете насолоджуватися високоякісними послугами ' +
          'мийки свого автомобіля. Ми пропонуємо зручний та економічний спосіб догляду за вашим авто, де ви самі контролюєте процес мийки.',
        'descTitle': "Автомийка самообслуговування на 4 накритих і 2 відкритих поста для великогабаритного транспорту до 10 " +
          "тонн. А три порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля." +
          "Для найкращого миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший " +
          "пістолет та використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму" +
          " ополікування пом'якшеним водою, змиваємо та наносимо нано віск для захисту вашого лакофарбового покриття. " +
        `Фінально вибираємо програму ополіскування осмотичною водою та надаємо блиск автомобілю.`,
        'descTitleEN': "Self-service car wash with 4 covered and 2 open stations for large vehicles up to 10 tons. And " +
          "three dusters with tire / plastic blackening and air blowing will provide comfort to the car's interior." +
          "For the best wash, we recommend applying active foam to the vehicle. After that, pick up another gun and use " +
          "the basic washing program with an active gel. After finishing the main wash, select the rinse program with softened " +
          "water, rinse and apply nano wax to protect your paintwork. Finally, we select the rinse program with osmotic water " +
          "and give the car a shine.",
        'descTitleRU': "Автомойка самообслуживания на 4 накрытых и 2 открытых поста для крупногабаритного транспорта до 10 тонн. " +
          "А три пылесоса с чернением шин/пластика и обдувом воздухом придадут комфорту интерьеру автомобиля.Для лучшего мытья " +
          "рекомендуем нанести активную пену на транспортное средство. После этого взять в " +
          "руки другой пистолет и использовать программу основную мойку активным гелем. Закончив основную мойку выбираем " +
          "программу пополковки смягченной водой, смываем и наносим нано воск для защиты вашего лакокрасочного покрытия. " +
          "Финально выбираем программу ополаскивания осмотической водой и придаем блеск автомобилю.",
        'metaDesc2': 'Обираючи нашу автомийку, ви отримуєте безліч переваг. Перш за все, ви економите час та зусилля, ' +
          'так як можете мити автомобіль самостійно, без черг та затримок. Крім того, наші сучасні мийки оснащені ' +
          'передовим обладнанням, яке забезпечує якісну та ефективну мийку, заощаджуючи воду та енергію.',
        'metaDesc2EN': 'By choosing our car wash, you get many advantages. First of all, you save time and effort, as ' +
          'you can wash the car yourself, without queues and delays. In addition, our modern sinks are equipped with ' +
          'advanced equipment that ensures high-quality and efficient washing, saving water and energy.',
        'metaDesc2RU': 'Выбирая нашу автомойку, вы получаете множество преимуществ. Прежде всего вы экономите время и ' +
          'усилия, так как можете мыть автомобиль самостоятельно, без очередей и задержек. Кроме того, наши современные' +
          ' мойки оснащены передовым оборудованием, обеспечивающим качественную и эффективную мойку, экономя воду и энергию.'
    },
    {
        'name': 'Мийка самообслуговування 6 постів',
        'desc': ['Попередня мийка гелем', 'Попередня мийка активною піною', 'Основна мийка гелем', 'Полоскання', 'Віск', 'Осмос', 'Щітка',
            'Оплата банківською картою Paypass' , 'Оплата готівкою', 'Оплата монетами номіналом 10 грн або жетонами'],
        'desc3': ['Pre-wash with gel', 'Pre-wash with active foam', 'Main wash with gel', 'Rinse', 'Wax', 'Osmosis', 'Brush', 'Payment by Paypass bank' +
        ' card', 'Payment in cash', 'Payment with UAH 10 coins or tokens'],
        'desc4': ['Предварительная мойка гелем', 'Предварительная мойка активной пеной', 'Основная мойка гелем', 'Полоскание', 'Воск', 'Осмос', 'Щетка',
            'Оплата банковской картой Paypass' , 'Оплата наличными', 'Оплата монетами номиналом 10 грн или жетонами'],
        'desc2': 'Для обслуговування великогабаритних автомобілей (до 10 тонн) передбачено два відкритих пости з ' +
          'додатковою програмою №3 "Миття щіткою". Для зручності відвідувачів передбачено шість пилососів потужністю 3 кВт.',
        'titleH1': ' на Окружна, Луцьк',
        'titleH1EN': ' at Okruzhna, Lutsk',
        'titleH1RU': ' на Окружная, Луцк',
        "descTitle": "Автомийка самообслуговування на 6 поста для великогабаритного транспорту до 10 тонн. А два " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
    ...
    },
    {
        ...
        'titleH1': ' на Авангардна, Лубни',
        'titleH1EN': ' at Avagardna, Lubny',
        'titleH1RU': ' на Авангардно, Лубны',
        "descTitle": "Автомийка самообслуговування на 6 поста для великогабаритного транспорту до 10 тонн. А два " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
    ...
    },
    {
        ...
        'titleH1': ' на Богдана Хмельницького 200, Львів',
        'titleH1EN': ' at Bohdan Khmelnytskyi 200, Lviv',
        'titleH1RU': ' на Богдана Хмельницкого 200, Львов',
        "descTitle": "Автомийка самообслуговування на 6 поста для великогабаритного транспорту до 10 тонн. А два " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
        ...
        'st2': 'bohdan-khmelnytskyi-200',
        'st3': 'Bohdan Khmelnytskyi 200',
        'st4': 'Богдана Хмельницкого 200',
    ...
    {
        'name': 'Мийка самообслуговування 10 постів',
        'desc': ['Піна', 'Попередня мийка активною піною', 'Основна мийка гелем', 'Полоскання', 'Віск', 'Осмос', 'Щітка',
            'Оплата банківською картою Paypass' , 'Оплата готівкою', 'Оплата монетами номіналом 10 грн або жетонами'],
        'desc3': ['Foam', 'Pre-wash with active foam', 'Main wash with gel', 'Rinse', 'Wax', 'Osmosis', 'Brush', 'Payment by Paypass bank' +
        ' card', 'Payment in cash', 'Payment with UAH 10 coins or tokens'],
        'desc4': ['Пина', 'Предварительная мойка активной пеной', 'Основная мойка гелем', 'Полоскание', 'Воск', 'Осмос', 'Щетка',
            'Оплата банковской картой Paypass' , 'Оплата наличными', 'Оплата монетами номиналом 10 грн или жетонами'],
        'desc2': '',
        'titleH1': ' на Львівська, Хуст',
        'titleH1EN': ' at Lvivska, Hust',
        'titleH1RU': ' на Львовская, Хуст',
        "descTitle": "Автомийка самообслуговування на 6 поста для великогабаритного транспорту до 10 тонн. А два " +
          "порохотяга з чорнінням шин / пластику та обдувом повітрям нададуть комфорту інтер'єру автомобіля.Для найкращого" +
          " миття рекомендуємо нанести активну піну на транспортний засіб. Після цього взяти в руки інший пістолет та " +
          "використати програму основне миття активним гелем. Закінчивши основне миття вибираємо програму ополікування " +
