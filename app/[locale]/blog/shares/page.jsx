        ...
        <main className={s.main}>
            ...
            <div>
                <div className={s.breadcrumbs}>
                    ...
                    <span className={s.breads2}> / {t(`blogs.shares`)}</span>
                </div>
                ...
                <div className={s.articleBlog}>
                    ...
                    {
                        articleAll?.map((item, index) => item.type === 'article' &&
                            <Link href={`/blog/shares/${item.slug}`} className={s.boxOne} key={index}
